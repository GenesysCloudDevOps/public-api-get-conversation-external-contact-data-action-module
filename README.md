A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Conversation External Contact
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-conversation-external-contact-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Conversation External Contact"
